...
RAM Backdoor Access Tool Parameters and Usage
---------------------------------------------
Parameters
[-a {address in hex}] - Start word address (16-bit) for reading/writing
[-l {length to read}] - Length in words to read from start address
[-d {data to write}] - Data words to write to start address
...
[-o] - Set offset of F81_RMI_DATA2 register from F81 data register base address

Usage examples
- Read five words of data starting from word address 0x048a
   -a 0x048a -l 5 -r
